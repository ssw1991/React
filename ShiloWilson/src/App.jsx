...
function App() {
  const linkClass = ({ isActive }) =>
    `px-3 py-2 rounded-full text-sm font-medium transition-colors duration-200 ${
      isActive ? 'bg-gray-900 text-white px-4 py-2.5' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-100'
    }`;

  return (
    <div className="min-h-screen flex flex-col bg-white text-gray-900">
      <header className="sticky top-0 z-40 bg-blue-100 backdrop-blur border-b border-gray-200">
        <div className="w-full px-4 py-4 flex flex-col items-center gap-4 text-center">
          <Header />
          <nav aria-label="Primary" className="w-auto">
            <ul className="flex flex-wrap justify-center gap-2">
              ...
              <li><NavLink to="/todo" className={linkClass}>TO DO</NavLink></li>
